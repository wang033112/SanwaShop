...
class CartListView: UIView {
    ...
    var productData: Array<CartModel> = Array.init()
...
//            tableView.deleteRows(at: [indexPath], with: UITableView.RowAnimation.automatic)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            cell = CartListCell.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "CartListCell")
        }
        let product: CartModel = productData[indexPath.row]
