...
class SearchRankingView: UIView {
    ...
    private lazy var topRankingItem: SearchRankingItem = {
        let Item = SearchRankingItem.init(icon: "rank_shirt", text: "Top")
        return Item
    }()
    
    private lazy var shoesRankingItem: SearchRankingItem = {
        let Item = SearchRankingItem.init(icon: "rank_shoes", text: "Shoes")
        return Item
    }()
    
    private lazy var trousersRankingItem: SearchRankingItem = {
        let Item = SearchRankingItem.init(icon: "rank_trousers", text: "Trousers")
        return Item
    }()
    
    private lazy var shirtRankingItem: SearchRankingItem = {
        let Item = SearchRankingItem.init(icon: "rank_shirt", text: "Shirt")
        return Item
    }()
...
extension SearchRankingView: UIScrollViewDelegate {

}


class SearchRankingItem: UIView {
