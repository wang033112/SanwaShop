...
//  Shop
//
//  Created by Ouketsu on 2021/05/17.
//
...
extension SearchRecentView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell: SearchRecentCell? = tableView.dequeueReusableCell(withIdentifier: "RecentTableViewCell") as? SearchRecentCell
        if cell == nil {
            cell = SearchRecentCell.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "RecentTableViewCell")
        }
