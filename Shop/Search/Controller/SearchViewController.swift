...
class SearchViewController: BaseViewController {
    ...
    lazy var rankingView: SearchRankingView = {
        let rankingView = SearchRankingView.init(frame: CGRect.zero)
        return rankingView
    }()
    
    lazy var recentView: SearchRecentView = {
        let recentView = SearchRecentView.init(frame: CGRect.zero)
        return recentView
    }()
