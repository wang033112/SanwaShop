...
class CheckoutShipmentView: UIView {
    ...
    lazy var freeButton: CheckoutFreightView = {
        let button = CheckoutFreightView.init(type: UIButton.ButtonType.custom)
    ...
    lazy var premiumButton: CheckoutFreightView = {
        let button = CheckoutFreightView.init(type: UIButton.ButtonType.custom)
...
class CheckoutFreightView: UIButton {
